...
@section('content1')
    ...
    <h1 class="text-primary">Create Class</h1>
    ...
    <div class="container">
            ...
            <div class="col-sm-10">
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        {!! Form::select('sportName_id', [''=>'Choose Sport'] + $sports, null,['class'=>'form-control', 'name'=>'sportName_id', 'id'=>'sportName_id']) !!}

                    </div>
                    <div class="form-group ">
                        {!! Form::label('level_id','Levels: ') !!}
                        {!! Form::select('level_id',[''=>'Choose levels'] + $levels, null,['class'=>'form-control', 'name'=>'level_id', 'id'=>'level_id']) !!}

                    </div>

                    <div class="form-group">
                        {!! Form::label('teacherName_id','Teacher Name : ') !!}
                        {!! Form::select('teacherName_id',[''=>'Choose Teacher'] + $teachers,null,['class'=>'form-control', 'name'=>'teacherName_id', 'id'=>'teacherName_id']) !!}
        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                {!! Form::submit('Create Class', ['class'=>'btn btn-primary', 'name'=>'send', 'id'=>'send']) !!}
